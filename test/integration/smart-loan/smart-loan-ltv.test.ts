...
import {MockSmartLoanLogicFacetSetValues, MockSmartLoanLogicFacetSetValues__factory} from "../../../typechain";
...
describe('Smart loan',  () => {
  ...
  describe('A loan with edge LTV cases', () => {
    ...
    before("deploy provider, exchange and pool", async () => {
      ...
      await recompileSmartLoanLib("SmartLoanLib", [0, 1, 3], {'AVAX': ethers.constants.AddressZero},  ethers.constants.AddressZero, ethers.constants.AddressZero, 'lib', 5000, 4000);
    });
